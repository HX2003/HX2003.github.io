...
.tabbar li:nth-child(3) p{
    border-width:1px;
	border-color:#000000;
	border-right-style:solid;
}
.tabbar li:nth-child(4) p{
    border-width:1px;
	border-color:#000000;
	border-right-style:solid;
}
.tabbar li:nth-child(5) p{
    border-width:1px;
	border-color:#000000;
	border-right-style:solid;
}
...
<script type="text/javascript" src="/website/tools/minigame2.js"></script>
<script type="text/javascript" src="/website/tools/dragscroll.js"></script>
...
<div id="resourcebar">
<b>
<span style="position:absolute;left:5px;">Energy: <span class="thetotal" style=""></span></span>
 
<span style="position:absolute;left:200px;">Research points:<span class="thetotalresearchpoint" style=""></span></span>
</b>
</div>
<!-- TABS -->
<ul class="tabbar">
  ...
  <li><p id="menuD" class="tabs"><b>Achievements</b></p></li>
  <li><p id="menuE" class="tabs"><b>Stats</b></p></li>
  <li><p id="menuF" class="tabs"><b>Settings N' Stuff</b></p></li>
</ul>
<div class="clear"></div>
...
<table style="font-size:22px;"><tr><td><div style="">Total Energy: </div></td><td><div class="thetotal" style=""></div></td></tr></table>
<table style="font-size:22px;"><tr><td><div style="">Total Research Points: </div></td><td><div class="thetotalresearchpoint" style=""></div></td></tr></table>
<div class="clear"></div>
<div id="clickbuy0000" class="clickbuy">Buy More Energy Pylons T1<span class="buytooltiptext">
...
<span class="details"><span>Cost: </span><span id="epcost0000" ></span><span id="errorcost0000" class="errorcost">Not enough energy</span><span> Amount acquired:</span><span id="epnum0000"></span></span>

<div class="clear"></div>

<div id="clickbuy0001" class="clickbuy">Buy More Energy Pylons T2<span class="buytooltiptext">
...
<span class="details"><span>Cost: </span><span id="epcost0001" ></span><span id="errorcost0001" class="errorcost">Not enough energy</span><span> Amount acquired:</span><span id="epnum0001"></span></span>
<div class="clear"></div>
<div id="clickbuy0002" class="clickbuy">Buy More Energy Pylons T3<span class="buytooltiptext">
<span>Increases epc by </span><b><span id="epcplus3"></span></b><span> each.</span>
<br>
<span>Increases epc by </span><b><span id="epctotal3"></span></b><span> in total.</span>
<br>
<span>(</span><b><span id="clickpercentage3"></span></b><span>% of total)</span>

</span>
</div>
<span class="details"><span>Cost: </span><span id="epcost0002" ></span><span id="errorcost0002" class="errorcost">Not enough energy</span><span> Amount acquired:</span><span id="epnum0002"></span></span>
...
<div id="autobuy0000" class="autobuy">Buy More Solar Panels <span class="buytooltiptext">
...
<span class="details"><span>Cost: </span><span id="egcost0000" ></span><span id="autoerrorcost0000" class="errorcost">Not enough energy</span><span> Amount acquired:</span><span id="egnum0000"></span></span>

<div class="clear"></div>

<div id="autobuy0001" class="autobuy">Buy More Wind Turbine<span class="buytooltiptext">
...
<span class="details"><span>Cost: </span><span id="egcost0001" ></span><span id="autoerrorcost0001" class="errorcost">Not enough energy</span><span> Amount acquired:</span><span id="egnum0001"></span></span>


<div class="clear"></div>

<div id="autobuy0002" class="autobuy">Buy More Energy Generator<span class="buytooltiptext">
...
<span class="details"><span>Cost: </span><span id="egcost0002" ></span><span id="autoerrorcost0002" class="errorcost">Not enough energy</span><span> Amount acquired:</span><span id="egnum0002"></span></span>
...
<div id="upgradesmaincontainer">
<div id="upgradescontainer" class="free dragscroll">
...
<div id="tabC" class="tabClass">
  ...
  Level:
  <span class="EnergyGoalLevel"></span>
  </div>
  <div class="clear"></div>
  <div id="energyGoal1" class="energyGoals"></div>
  <div id="energyGoal2" class="energyGoals"></div>
  <div id="energyGoal3" class="energyGoals"></div>
  <div id="energyGoal4" class="energyGoals"></div>
  <div id="energyGoal5" class="energyGoals"></div>
  <div id="energyGoal6" class="energyGoals"></div>
  <div id="energyGoal7" class="energyGoals"></div>
  <div id="energyGoal8" class="energyGoals"></div>
  <div id="energyGoal9" class="energyGoals"></div>
</div>

<div id="tabD" class="tabClass">
  <br>  
  <h2>Achievements</h2>
  <p>See your your achievements here, achievements can give bonuses.</p>
...
<div id="tabE" class="tabClass">
  <br>
  <h2>Stats</h2>
  <p>See your stats here.</p>
...
<tr><td>Energy goal level:</td><td><div class="EnergyGoalLevel"></div></td></tr>
<tr><td><p style="font-size:20px;">Energy multiplyier:<p></td><td><div id="emultiply"></div></td></tr>
</table>
</div>

</div>
<div id="tabF" class="tabClass">
  <br>
  <h2>Settings N' Stuff</h2>
  <p> </p>
...
<div id="centernotify"><div id="notifyTitle" style="font-size:24px;">Notifications:</div></div>
</div>
<!--
BOTTOM
