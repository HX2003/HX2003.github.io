...
.upgradebox:hover .upgradetooltiptext {
    visibility: visible;
}
.upgradebox .upgradetooltiptext {
    width: 300px;
...
#canceldialog { 	cursor:pointer;display:block; position:absolute; top:3px; right:2px; color:black; height:30px; width:35px; font-size:30px; text-decoration:none; text-align:center; font-weight:bold; }
#yes {
	width:100px;
	padding:0px;
...
<script type="text/javascript" src="<?php echo $host;?>/website/tools/minigame.js"></script>
...
<table style="font-size:25px;"><tr><td><div style="">Total Energy: </div></td><td><div id="thetotal" style=""></div></td></tr></table>
<div class="clear"></div>
...
<tr><td>Energy multiplyier:</td><td><div id="emultiply"></div></td></tr>
</table>
